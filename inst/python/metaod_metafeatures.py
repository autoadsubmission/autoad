...
def generate_meta_features(X):
    ...
    Returns
    -------
    meta_features : array of length 200
        Meta-feature in dimension of 200
    meta_features_names : string array of length 200
        Names of the meta-features, in the corresponding order
    """
    ...
    q1, q25, q75, q99 = np.percentile(X, [1, 25, 75, 99])
    iqr = q75 - q25
